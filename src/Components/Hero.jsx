      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
               <motion.h1 
                ...
                initial="hidden"
                animate="visible"
                className="pb-16 text-6xl  tracking-tight lg:mt-16 lg:text-8xl">Pothireddy Sanjana</motion.h1>
               <motion.span 
               ...
               className="bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-transparent text-3xl tracking-tight">
                     Salesforce  & Front End Developers
               </motion.span>   
                <motion.p 
        ...
        <div className=" w-full lg:w-1/2 flex justify-center lg:justify-end lg:p-10  ">
            <div className=" w-1/2 lg:w-1/2 ">
                ...
                src={profilePic} alt="profile" className="w-full lg:w-full rounded-2xl "/>
            </div>
        </div>
      </div>
    </div>
